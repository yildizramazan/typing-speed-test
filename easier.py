...
text_entry = Entry(bg="#8ECDDD", fg=BLACK, font=(FONT_NAME, 15))
...
submit_button = Button(command=calculating_wpm, text="Submit", state="disabled", width=15, height=2, font=(FONT_NAME, 20, "bold"), fg="#22668D")
submit_button.grid(row=2, column=1)

canvas = Canvas(width=200, height=224, bg=YELLOW, highlightthickness=0)

timer_text = canvas.create_text(60, 65, text="00:00", fill=BLACK, font=(FONT_NAME, 40, "bold"))
canvas.grid(column=1, row=0, padx=75, pady=0)
